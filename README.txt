...
INIT.PY
This Python module takes all the input files and initialzes all corresponding 
...
FUNC.PY
This Python module holds a variety of functions used by main.py and init.py. 
